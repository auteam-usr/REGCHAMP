...
qm create 100 --name "ISP" --cores 1 --memory 1024 --ostype l26 --scsihw virtio-scsi-single --serial0 socket --net0 virtio,bridge=vmbr0 --net1 virtio,bridge=vmbr1 --net2 virtio,bridge=vmbr2
...
qm create 103 --name "SW-HQ" --cores 1 --memory 1024 --ostype l26 --scsihw virtio-scsi-single --serial0 socket  --net0 virtio,bridge=vmbr3 --net1 virtio,bridge=vmbr5 --net2 virtio,bridge=vmbr6 --net3 virtio,bridge=vmbr7
qm importdisk 103 ALT_Server.vmdk local-lvm --format qcow2 
qm set 103 -scsi0 local-lvm:vm-103-disk-0 --boot order=scsi0
echo "SW-HQ is done!!!"

qm create 104 --name "SW-BR" --cores 1 --memory 1024 --ostype l26 --scsihw virtio-scsi-single --serial0 socket  --net0 virtio,bridge=vmbr4 --net1 virtio,bridge=vmbr8 --net2 virtio,bridge=vmbr9
qm importdisk 104 ALT_Server.vmdk local-lvm --format qcow2 
qm set 104 -scsi0 local-lvm:vm-104-disk-0 --boot order=scsi0
echo "SW-BR is done!!!"

qm create 105 --name "SRV-HQ" --cores 2 --memory 4096 --ostype l26 --scsihw virtio-scsi-single --serial0 socket --net0 virtio,bridge=vmbr7
...
qm create 106 --name "SRV-BR" --cores 2 --memory 2048 --ostype l26 --scsihw virtio-scsi-single --serial0 socket  --net0 virtio,bridge=vmbr8 
...
qm create 107 --name "CLI-HQ" --cores 2 --memory 2048 --ostype l26 --scsihw virtio-scsi-single --serial0 socket --net0 virtio,bridge=vmbr5 
qm importdisk 107 ALT_Workstation.vmdk local-lvm --format qcow2
qm set 107 -scsi0 local-lvm:vm-107-disk-0 --boot order=scsi0
echo "CLI-HQ is done!!!"

qm create 108 --name "CLI-BR" --cores 2 --memory 2048 --ostype l26 --scsihw virtio-scsi-single --serial0 socket  --net0 virtio,bridge=vmbr9 
qm importdisk 108 ALT_Workstation.vmdk local-lvm --format qcow2 
qm set 108 -scsi0 local-lvm:vm-108-disk-0 --boot order=scsi0
echo "CLI-BR is done!!!"

qm create 109 --name "CICD-HQ" --cores 2 --memory 2048 --ostype l26 --scsihw virtio-scsi-single --serial0 socket --net0 virtio,bridge=vmbr6 
